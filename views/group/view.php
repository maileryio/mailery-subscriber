...
?><div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Group #<?= $group->getId() ?></h1>
            <div class="btn-toolbar float-right">
                ...
                ?>
                <a class="btn btn-sm btn-secondary mx-sm-1 mb-2" href="<?= $urlGenerator->generate('/subscriber/group/edit', ['id' => $group->getId()]) ?>">
    ...
    <div class="col-12 grid-margin">
        <?= DetailView::widget()
            ...
            ->attributes([
                [
                    'label' => 'Name',
                    'value' => function (Group $data, $index) {
                        return $data->getName();
                    },
                ],
                [
